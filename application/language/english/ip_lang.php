...
$lang = array(
    ...
    'qr_code_swiss_settings_enable_hint'           => 'Enabling this option will include a QR Code Swiss page after the invoice.You must fill in the user\'s IBAN as well as the currency to use (CHF or EUR only). Otherwise, the QR Code Swiss page will not be displayed.',
