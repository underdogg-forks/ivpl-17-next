                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="settings[default_hourly_rate]" id="settings[default_hourly_rate]"
                                    ...
                                    value="<?php echo get_setting('default_hourly_rate') !== '' && get_setting('default_hourly_rate') !== '0' ? format_amount(get_setting('default_hourly_rate')) : get_setting('default_hourly_rate'); ?>">
