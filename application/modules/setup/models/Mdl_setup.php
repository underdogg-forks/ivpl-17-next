 ...
 * Class Mdl_Setup.
 */
final class Mdl_Setup extends CI_Model
{
    public $db;
    ...
    public function install_default_data(): void
    {
        $this->db->insert(
            'ip_invoice_groups',
            ['invoice_group_name' => 'Invoice Default', 'invoice_group_next_id' => 1]
        );

        $this->db->insert(
            'ip_invoice_groups',
            ['invoice_group_name' => 'Quote Default', 'invoice_group_prefix' => 'QUO', 'invoice_group_next_id' => 1]
        );
     ...
     */
    public function upgrade_006_1_2_0(): void
    {
    ...
    public function upgrade_019_1_4_7(): void
    {
    ...
    public function upgrade_023_1_5_0(): void
    {
        ...
        // Create tables
        $this->db->query(
            'CREATE TABLE `ip_client_custom_new`
            (
        ...
        $this->db->query(
            'CREATE TABLE `ip_invoice_custom_new`
            (
        ...
        $this->db->query(
            'CREATE TABLE `ip_quote_custom_new`
            (
        ...
        $this->db->query(
            'CREATE TABLE `ip_payment_custom_new`
            (
        ...
        $this->db->query(
            'CREATE TABLE `ip_user_custom_new`
            (
    ...
    public function upgrade_029_1_5_6(): void
    {
    ...
    public function upgrade_036_1_6(): void
    {
     ...
     */
    private function execute_contents($contents): void
    {
     ...
     * @param $sql_file
     */
    private function save_version($sql_file): void
    {
    ...
    private function install_default_settings(): void
    {
