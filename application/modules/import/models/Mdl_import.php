 ...
 * Class Mdl_Import.
 */
final class Mdl_Import extends Response_Model
{
    public $mdl_invoices;
     ...
     * @param $ids
     */
    public function record_import_details($import_id, $table_name, $import_lang_key, $ids): void
    {
        foreach ($ids as $id) {
     ...
     * @param int $import_id
     */
    public function delete($import_id): void
    {
