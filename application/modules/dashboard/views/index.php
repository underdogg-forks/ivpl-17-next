                    ...
                    <table class="table table-hover table-striped table-condensed no-margin">
                        ...
                        <?php foreach ($quotes as $quote) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo anchor('quotes/view/' . $quote->quote_id, ($quote->quote_number ?: $quote->quote_id)); ?>
                                </td>
                                <td>
                    ...
                    <table class="table table-hover table-striped table-condensed no-margin">
                        ...
                        <?php foreach ($invoices as $invoice) {
                            ...
                            if ($invoice->invoice_sign == '-1') { ?>
                                ...
                                <td>
                                    <?php echo anchor('invoices/view/' . $invoice->invoice_id, ($invoice->invoice_number ?: $invoice->invoice_id)); ?>
                                </td>
                                <td>
